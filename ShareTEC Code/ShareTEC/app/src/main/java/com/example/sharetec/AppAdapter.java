...
public class AppAdapter extends RecyclerView.Adapter<AppAdapter.AppViewHolder> {
    ...
    Context context;
    List<com.example.sharetec.App> apps;


    public AppAdapter(Context context, List<com.example.sharetec.App> apps) {
    ...
    public void onBindViewHolder(@NonNull AppViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                context.startActivity(Intent.createChooser(shareAPkIntent,"ShareTEC"));
